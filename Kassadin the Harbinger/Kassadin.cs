        ...
        private static void OnCombo()
        {
            ...
            if (comboTarget.IsValidTarget())
            {
                    ...
                    && SkillsHandler.Spells[SpellSlot.R].IsReady())
                {
                    ...
                    {
                        if (SkillsHandler.Spells[SpellSlot.R].Instance.ManaCost < 300)
                        {
                        ...
                        if (SkillsHandler.Spells[SpellSlot.R].Instance.ManaCost > 300 && SkillsHandler.Spells[SpellSlot.R].IsKillable(comboTarget) && player.Mana > SkillsHandler.Spells[SpellSlot.R].Instance.ManaCost)
                        {
                            SkillsHandler.Spells[SpellSlot.R].Cast(comboTarget.ServerPosition);
                        }
                    }
