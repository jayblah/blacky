...
namespace BlackZilean.Utility
{
    public class MenuGenerator
    {
        public static void Load()
        {
            ...
            {
                drawingMenu.AddItem(new MenuItem("zilean.drawing.drawQ", "Draw Q").SetValue(new Circle(true, Color.Crimson)));
                drawingMenu.AddItem(new MenuItem("zilean.drawing.drawW", "Draw W").SetValue(new Circle(true, Color.Crimson)));
                drawingMenu.AddItem(new MenuItem("zilean.drawing.drawE", "Draw E").SetValue(new Circle(true, Color.Crimson)));
                drawingMenu.AddItem(new MenuItem("zilean.drawing.drawR", "Draw R").SetValue(new Circle(true, Color.Crimson)));
