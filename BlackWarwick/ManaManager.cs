...
namespace BlackWarwick
{
    internal class ManaManager
    {
        ...
        public void CreateMenu()
        {
            ...
            {
                manaMenu.AddItem(new MenuItem("minHarassMana", "Mana % for Harass").SetValue(new Slider(40)));
                manaMenu.AddItem(new MenuItem("minLaneclearMana", "Mana % for Wave & Jungleclear").SetValue(new Slider(40)));
            }
        ...
        {
            return !(_player.ManaPercent <= _menu.Item("minHarassMana").GetValue<Slider>().Value);
        } 

        public bool CanLaneclear()
        {
            return !(_player.ManaPercent <= _menu.Item("minLaneclearMana").GetValue<Slider>().Value);
        }
    }
}